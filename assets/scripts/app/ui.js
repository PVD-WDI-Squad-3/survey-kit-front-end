...
const onGetSurveySuccess = function (data) {
  ...
  q.forEach(function(question) {
    $('#quiz').append('<h3>' + question.content.question + '</h3>' + '<input type="radio" class="1" name="quiz-answer" value="0" id="' + question.content.answers[0].id + '">' + question.content.answers[0].answer + '<br> <input type="radio" class="1" name="quiz-answer" value="1" id="' + question.content.answers[1].id + '">' + question.content.answers[1].answer + '<br> <input type="radio" class="2" name="quiz-answer" value="2" id="' + question.content.answers[2].id + '">' + question.content.answers[2].answer + '<br> <input type="radio" class="3" name="quiz-answer" value="3" id="' + question.content.answers[3].id + '">' + question.content.answers[3].answer + '<br>')
  })
